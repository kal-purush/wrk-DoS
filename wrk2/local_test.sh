...
for framework_name in ${framework_names[@]}; do
    ...
    payload_length=(25 1000 5000);
    for r in ${payload_length[@]}; do
        # url="https://python-wrk-dos-297bbdc7a05a.herokuapp.com/$framework_name";
        url="https://wrk-dos-fufwchdhhedzgegq.germanywestcentral-01.azurewebsites.net/$framework_name";
        benign_url="https://wrk-dos-fufwchdhhedzgegq.germanywestcentral-01.azurewebsites.net/"
        ...
        # result=$(create_truncate_payload $r)
        # echo "$result"
        python3 wrk-DoS.py -m 1 -t 15 -d 70 -H "payload:$result" --payload "data=example" -R 40 -u $benign_url -a $url -p $folder_name --attack-rate 40
